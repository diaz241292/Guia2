...
public class Descargar extends AsyncTask<String, Integer, Estado> {
    ...
    public Descargar(Context context, TextView estado, Button descargar, ProgressBar progressBar,EditText txtNombre) {
    ...
    protected Estado doInBackground(String... sUrl) {
        ...
        try {
           ...
           ruta = Environment
            ...
            for(Integer contador=0; contador<= entrada.read(data) ;contador++){
                try{
                    Thread.sleep(70);
